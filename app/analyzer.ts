...
function prepareLedgerAging(d:DataSet,supplier:boolean,closing:number,now:Date,creditDays=30){
  ...
  const basis=invoiceDate?`الاستحقاق محسوب من تاريخ إصدار كل فاتورة + المدة المختارة، مع توزيع المردودات والسداد على أقدم فاتورة أولًا (FIFO).`:date?`الاستحقاق محسوب من التاريخ الموجود في سطر الفاتورة + المدة المختارة، مع توزيع الخصومات على أقدم فاتورة أولًا (FIFO).`:"لم يظهر تاريخ فاتورة صالح؛ لا يمكن اعتماد توزيع الأعمار دون تاريخ الإصدار.";
