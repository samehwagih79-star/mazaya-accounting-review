...
export type AnalysisResult = {
  ...
  dueSchedule?: { asOf: string; includedThrough: string; cutoffInvoiceDate?: string; cutoffBalance?: string; laterDeductions?: string; nextDueDate?: string; nextDueAmount?: string; nextDueRef?: string; nextDueDays?: number; nextDueCreditDays?: number };
